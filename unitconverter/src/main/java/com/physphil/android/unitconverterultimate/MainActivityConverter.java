 ...
 */
public class MainActivityConverter extends BaseActivity implements MainActivityView, SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.drawer_settings) {
                    PreferencesActivity.start(MainActivityConverter.this);
                    return true;
                }
